...
export default async function HomePage({ searchParams }) {
  try {
    ...
    // Fixed: use searchParams as passed argument
    const selectedCategory = searchParams && searchParams.category;
